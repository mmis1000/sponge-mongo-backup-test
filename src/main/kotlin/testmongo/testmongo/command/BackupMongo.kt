...
class BackupMongo : CommandExecutor {
    companion object {
        val spec: CommandSpec = CommandSpec.builder()
                .executor(BackupMongo())
    ...
    override fun execute(src: CommandSource, args: CommandContext): CommandResult {
        ...
        GlobalScope.launch {
            try {
                ...
                val fileOutputStream = TestMongo.bukkit.openUploadStream(fileName, options)
                ...
                launch(TestMongo.serverThread) {
                    ...
                    src.sendMessage("The fileId of the uploaded file is: ${fileOutputStream.fileId.toHexString()}".spongeText)
                }
            } catch (e: IOException) {
                launch(TestMongo.serverThread) {
